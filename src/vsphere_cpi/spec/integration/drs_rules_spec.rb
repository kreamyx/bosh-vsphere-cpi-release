        ...
        it 'should correctly apply VM Anti-Affinity rules to created VMs' do
          begin
            ...
            expect do
              ...
              vms.push(failed_vm)
            end.to raise_error(VSphereCloud::VMPowerOnError, be_unplaceable)
            # { |error|
            #   expect(error.fault).to be_kind_of(VimSdk::Vim::Fault::RuleViolation).or be_kind_of(VimSdk::Vim::Fault::GenericDrsFault)
            # }
          ensure
